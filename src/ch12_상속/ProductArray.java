...
public class ProductArray {
	...
	public static void main(String[] args) {
		...
		products[0] = new Computer("삼성컴퓨터", 1000, "데스크탑"); // 객체 생성
		products[1] = new Clothes("하의", 1000, "L", "red");
		products[2] = new Computer("맥북", 2000, "랩탑");
		products[3] = new Clothes("상의", 1000, "M", "black");
		...
		for(int i = 0; i < products.length; i++) {
			...
			if(products[i] instanceof Computer) {
				...
				System.out.println("제품타입: " + computer.getType());
			}else if(products[i] instanceof Clothes) {
				System.out.println("의류임");
